...
\begin{block}{Shape model reconstruction from LIDAR} % results block
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Immense collection of points capture the surface topology of the asteroid
            \item Surface reconstruction methods are used to transform the cloud into a mesh 
    ...
    \begin{minipage}[t]{0.5\columnwidth}
    \begin{itemize}
        \item Spacecraft simulated with LIDAR range sensor
        \item Talk about surface reconstruction
    \end{itemize}
    \end{minipage}

\begin{figure}[htbp] 
    \centering
    \subcaptionbox{LIDAR measurement\label{fig:lidar}}{\includegraphics[width=0.5\textwidth]{figures/itokawa_lidar.jpg}}
\end{figure}
...
\begin{block}{Computational Geometry}
    ...
    \begin{figure}
        \centering
        \subcaptionbox{Vertex\label{fig:vertex}}{\includegraphics[width=0.5\textwidth]{figures/cube_vertex.jpg}}~   
        \subcaptionbox{Edge\label{fig:edge}}{\includegraphics[width=0.5\textwidth]{figures/cube_edge.jpg}}

        \subcaptionbox{Face\label{fig:face}}{\includegraphics[width=0.5\textwidth]{figures/cube_face.jpg}}
    \end{figure}
\end{block}
