...
\begin{block}{Controlled Dynamics around NEAR Earth Asteroids} % structure block
	...
	\begin{minipage}{0.5\columnwidth}% right half of block
        ...
        \begin{figure}
            ...
            \subcaptionbox{4769 Castalia\label{fig:castalia}}{\includegraphics[width=0.4\columnwidth,height=0.15\columnheight]{figures/castalia.jpg}}
        \end{figure}
...
\begin{block}{Computational Geometry}
    ...
    \begin{figure}
        \centering
        \subcaptionbox{Vertex\label{fig:vertex}}{\includegraphics[width=0.52\textwidth]{figures/cube_vertex.jpg}}~   
        \subcaptionbox{Edge\label{fig:edge}}{\includegraphics[width=0.52\textwidth]{figures/cube_edge.jpg}}\\

        \subcaptionbox{Face\label{fig:face}}{\includegraphics[width=0.6\textwidth]{figures/cube_face.jpg}}
    \end{figure}
\end{block}
